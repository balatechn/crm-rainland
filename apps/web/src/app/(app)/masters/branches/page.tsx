...
export default function BranchesMaster() {
  ...
  const [form, setForm] = useState({ name:'', city:'', pincode:'', address:'', phone:'' });
  ...
  async function save(e: React.FormEvent) {
    ...
    setForm({ name:'', city:'', pincode:'', address:'', phone:'' }); load();
  }
  ...
  return (
    <div className="space-y-4">
      ...
      <form onSubmit={save} className="card p-3 grid md:grid-cols-5 gap-2">
      ...
      <div className="card overflow-x-auto">
        <table className="table">
          <thead><tr><th>Name</th><th>City</th><th>Pincode</th><th>Phone</th><th>Active</th><th></th></tr></thead>
          <tbody>
            {items.map(b => (
              <tr key={b.id}>
